      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 px-12 pb-20 max-w-screen-2xl mx-auto font-body text-sm">
        <div className="col-span-1 md:col-span-1 space-y-6">
          ...
          <div className="flex gap-4">
            <a
              className="w-10 h-10 rounded-full bg-surface flex items-center justify-center ambient-shadow hover:text-primary transition-all"
              href="#"
            >
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-4 text-slate-500">
            <li><Link className="hover:text-emerald-600 transition-all" href="/">Home</Link></li>
            <li><Link className="hover:text-emerald-600 transition-all" href="/#features">Features</Link></li>
            <li><Link className="hover:text-emerald-600 transition-all" href="/#safety">Safety</Link></li>
            <li><Link className="hover:text-emerald-600 transition-all" href="/#roadmap">Roadmap</Link></li>
          </ul>
        </div>
        <div className="space-y-6">
          <h4 className="font-headline font-bold text-emerald-900 uppercase tracking-widest text-xs">Company</h4>
          <ul className="space-y-4 text-slate-500">
            <li><Link className="hover:text-emerald-600 transition-all" href="#">About Us</Link></li>
            <li><Link className="hover:text-emerald-600 transition-all" href="/contact">Contact</Link></li>
          </ul>
        </div>
        <div className="space-y-6">
          ...
          <div className="flex">
            <input
              className="bg-surface border-none rounded-l-xl w-full px-4 py-3 text-sm focus:ring-2 focus:ring-emerald-500"
