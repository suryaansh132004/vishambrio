    ...
    <div className="booking-step active animate-entrance">
      ...
      <div className="space-y-4">
        ...
        <div 
          ...
          className={`fleet-selection-card p-5 rounded-2xl border-2 cursor-pointer transition-all hover:shadow-md ${formData.fleet === 'nexon' ? 'selected' : 'bg-white'}`}
        >
        ...
        <div 
          ...
          className={`fleet-selection-card p-5 rounded-2xl border-2 cursor-pointer transition-all hover:shadow-md ${formData.fleet === 'xprest' ? 'selected' : 'bg-white'}`}
        >
          <div className="flex justify-between items-center">
            <div className="space-y-2">
              <div className="flex items-center gap-2">
        ...
        <div className="p-4 bg-emerald-50/60 rounded-xl flex gap-3 text-xs text-emerald-900 border border-emerald-100">
          <span className="material-symbols-outlined text-lg text-emerald-700 flex-shrink-0" style={{ fontVariationSettings: "'FILL' 1" }}>bolt</span>
